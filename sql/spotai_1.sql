...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='user preference profile shard 0';
...
CREATE TABLE `tb_user_preference_1` (
                                        ...
                                        PRIMARY KEY (`id`) USING BTREE,
                                        UNIQUE KEY `uk_user_id` (`user_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='user preference profile shard 1';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='user behavior log shard 0';
...
CREATE TABLE `tb_user_behavior_log_1` (
                                          ...
                                          KEY `idx_target` (`target_type`,`target_id`) USING BTREE,
                                          KEY `idx_behavior_type` (`behavior_type`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='user behavior log shard 1';
...
CREATE TABLE `tb_review` (
                             ...
                             KEY `idx_user_time` (`user_id`,`create_time`) USING BTREE,
                             KEY `idx_order_id` (`order_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='shop review table';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='review image table';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='review like table';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='review AI analysis table';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='review embedding metadata table';
...
CREATE TABLE `tb_ai_conversation_0` (
                                        ...
                                        KEY `idx_user_time` (`user_id`,`create_time`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='AI conversation shard 0';
...
CREATE TABLE `tb_ai_conversation_1` (
                                        ...
                                        KEY `idx_session_time` (`session_id`,`create_time`) USING BTREE,
                                        KEY `idx_user_time` (`user_id`,`create_time`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='AI conversation shard 1';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='AI tool call log shard 0';
...
CREATE TABLE `tb_ai_tool_call_log_1` (
                                         ...
                                         KEY `idx_tool_name` (`tool_name`) USING BTREE,
                                         KEY `idx_confirm_token` (`confirm_token`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='AI tool call log shard 1';
...
CREATE TABLE `tb_ai_tool_confirm_0` (
                                       ...
                                       KEY `idx_user_time` (`user_id`,`create_time`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='AI tool confirmation shard 0';
...
CREATE TABLE `tb_ai_tool_confirm_1` (
                                       ...
                                       KEY `idx_tool_call_id` (`tool_call_id`) USING BTREE,
                                       KEY `idx_user_time` (`user_id`,`create_time`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='AI tool confirmation shard 1';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='AI recommendation log shard 0';
...
CREATE TABLE `tb_ai_recommend_log_1` (
                                        ...
                                        KEY `idx_voucher_id` (`voucher_id`) USING BTREE,
                                        KEY `idx_session_id` (`session_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='AI recommendation log shard 1';
